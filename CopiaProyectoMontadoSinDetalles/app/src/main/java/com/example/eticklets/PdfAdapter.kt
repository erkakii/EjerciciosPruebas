...
class PdfAdapter(private val pdfList: MutableList<PdfsGet>, private val onItemClickListener: (PdfsGet) -> Unit, private val onDeleteClickListener: (PdfsGet) -> Unit) : RecyclerView.Adapter<PdfAdapter.PdfViewHolder>() {
